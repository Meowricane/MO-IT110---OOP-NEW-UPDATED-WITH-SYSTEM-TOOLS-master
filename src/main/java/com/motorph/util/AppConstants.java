...
public final class AppConstants {
    ...
    public static final Color SIDEBAR_BACKGROUND = new Color(97, 8, 30); // rgba(97, 8, 30, 1) - slate-700 (darker sidebar)
    ...
    // Button Colors
    public static final Color PRIMARY_BUTTON_COLOR = new Color(114, 26, 26); // rgba(114, 26, 26, 1) - indigo-600
    public static final Color PRIMARY_BUTTON_HOVER = new Color(79, 70, 229); // #e54646ff - indigo-700
    public static final Color SECONDARY_BUTTON_COLOR = new Color(107, 114, 128); // #6B7280 - gray-500
    public static final Color SECONDARY_BUTTON_HOVER = new Color(141, 148, 81); // rgba(112, 123, 146, 1) - gray-600
    public static final Color BUTTON_TEXT_COLOR = new Color(252, 252, 252); // rgba(252, 252, 252, 0.91)
    ...
    public static final Color TEXT_COLOR = new Color(0, 0, 0); // rgba(0, 0, 0, 0.56) - slate-700
    public static final Color TEXT_SECONDARY = new Color(100, 116, 139); // #6b88b1ff - slate-500
    ...
    public static final Color ACTION_VIEW_COLOR = new Color(14, 165, 233); // #c1e90eff - sky-500
    ...
    public static final Color EDIT_BUTTON_COLOR = new Color(131, 69, 69); // rgba(131, 69, 69, 1) - orange-400
    public static final Color BORDER_SOLID = new Color(203, 213, 225); // #CBD5E1 - slate-300
    public static final Color ACCENT_PRIMARY = new Color(131, 54, 58); // rgba(131, 54, 58, 1) - indigo-600
    ...
    public static final Color SELECTION_COLOR = new Color(219, 234, 254); // #31b66dff - blue-100
