...
public class Employee {
    ...
    // Minimal constructor (if still needed for DAO)
    ...
    // Full constructor used in DataRepository
    public Employee(int employeeId, String lastName, String firstName,
    ...
    public void setBasicSalary(double basicSalary) { this.basicSalary = basicSalary; calculateHourlyRate(); }
